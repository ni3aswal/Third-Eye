...
Public Class admin
    ...
    Private Sub Hindi_Click(sender As Object, e As EventArgs) Handles Hindi.Click
        hinadmin.Show()
    End Sub

    Private Sub Marathi_Click(sender As Object, e As EventArgs) Handles Marathi.Click
        maradmin.Show()
    End Sub

    Private Sub changemedia_Click(sender As Object, e As EventArgs) Handles changemedia.Click
        GroupBox2.Show()
        create.Location = New Point(7, 389)
        back.Location = New Point(7, 442)
        Me.Size = New Size(355, 535)
    End Sub

    Private Sub changemenu_Click(sender As Object, e As EventArgs) Handles changemenu.Click
        GroupBox2.Hide()
        create.Location = New Point(7, 316)
        back.Location = New Point(7, 370)
