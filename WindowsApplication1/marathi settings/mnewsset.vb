...
Public Class mnewsset
    Private Sub mnewsset_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        maradmin.Show()
    End Sub
    Private Sub mnewsset_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '1
        mnews.a = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\1.txt")
        file1.Text = My.Computer.FileSystem.GetName(mnews.a)
        '2
        mnews.b = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\2.txt")
        file2.Text = My.Computer.FileSystem.GetName(mnews.b)
        '3 
        mnews.c = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\3.txt")
        file3.Text = My.Computer.FileSystem.GetName(mnews.c)
        '4
        mnews.d = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\4.txt")
        file4.Text = My.Computer.FileSystem.GetName(mnews.d)
        '5
        mnews.f = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\5.txt")
        file5.Text = My.Computer.FileSystem.GetName(mnews.f)
        '6
        mnews.g = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\6.txt")
        file6.Text = My.Computer.FileSystem.GetName(mnews.g)
    ...
    Private Sub update1_Click(sender As Object, e As EventArgs) Handles update1.Click
        ...
        Else
            File.WriteAllText(Application.StartupPath + "\\third eye\marathi\news\1.txt", TextBox1.Text)
            mnews.a = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\1.txt")
