...
Public Class mnews
    ...
    Private Sub mnews_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        My.Computer.Audio.Play(Application.StartupPath + "\audio\marathi\mnews.wav", AudioPlayMode.BackgroundLoop)
        AxWindowsMediaPlayer1.Hide()
        a = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\1.txt")
        b = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\2.txt")
        c = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\3.txt")
        d = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\4.txt")
        f = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\5.txt")
        g = File.ReadAllText(Application.StartupPath + "\\third eye\marathi\news\6.txt")
    End Sub
    Private Sub mnews_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
